    ...
    <section id="servicos" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
            ...
            <div className="relative grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
                ...
                {/* Card 1: Diagnóstico */}
                <motion.div 
                    className="relative bg-gradient-to-br from-rose-50 to-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center"
                ...
                >
                    ...
                    <h3 className="font-bold text-lg md:text-xl text-gray-900 mb-3">Diagnóstico Preciso</h3>
                ...
                {/* Card 2: Plano */}
                <motion.div 
                    className="relative bg-gradient-to-br from-pink-50 to-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center"
                    whileHover={{ y: -10, scale: 1.03 }}
                    transition={{ type: "spring", stiffness: 300 }}
                >
                    ...
                    <h3 className="font-bold text-lg md:text-xl text-gray-900 mb-3">Plano Terapêutico Singular</h3>
                ...
                <motion.div 
                    className="relative bg-gradient-to-br from-fuchsia-50 to-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 flex flex-col items-center text-center"
                    whileHover={{ y: -10, scale: 1.03 }}
                    transition={{ type: "spring", stiffness: 300 }}
                >
                    ...
                    <h3 className="font-bold text-lg md:text-xl text-gray-900 mb-3">Tratamento com Cannabis Medicinal</h3>
