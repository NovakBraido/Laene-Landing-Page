...
// SUGESTÃO: Melhorar os ícones com design mais moderno
...
const FaqItem: React.FC<FaqItemProps> = ({ question, answer }) => {
    ...
    return (
        // SUGESTÃO: Adicionar sombras sutis nos cards
        <div className="bg-white rounded-xl shadow-sm border border-gray-200/80 overflow-hidden">
            ...
            {/* SUGESTÃO: Implementar animações suaves na abertura/fechamento */}
            <AnimatePresence>
                {isOpen && (
                    <motion.div
    ...
    return (
        <section id="faq" className="bg-brand-pink-light py-16 md:py-24">
            <div className="container mx-auto px-6">
                ...
                {/* O container agora adiciona um espaço entre cada card */}
