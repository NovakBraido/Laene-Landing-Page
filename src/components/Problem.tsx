        ...
        <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-gray-200">
                    <h3 className="font-bold text-lg md:text-xl text-gray-800 mb-3">Dificuldades na Escola</h3>
                ...
                <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-gray-200">
                    <h3 className="font-bold text-lg md:text-xl text-gray-800 mb-3">Comportamentos Desafiadores</h3>
                ...
                <div className="bg-gray-50 p-6 md:p-8 rounded-xl shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-gray-200">
                    <h3 className="font-bold text-lg md:text-xl text-gray-800 mb-3">Incerteza e Medo do Futuro</h3>
